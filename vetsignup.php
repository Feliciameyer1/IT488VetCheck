...
?>
    <div class="container body">
        <h2 class="text-center">Veterinarian Signup</h2>
        <form onsubmit="return passwordRepeat.oninput(this)" action="php/vetsignup.php" method="POST">
            <div class="form-group">
                <label for="name">Name of Practice</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Vet Practice" required>
            </div>
            <div class="form-group">
